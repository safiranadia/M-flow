...
<div class="mx-4 md:mx-10">
    <div class="bg-white shadow-lg rounded-xl p-6 max-w-3xl mx-auto">
        ...
        <h2 class="text-xl font-bold text-purple-700 mb-6">
            Edit Monitoring Mesin & Produksi
        </h2>
        ...
        <form method="POST" action="#">
            ...
            <div class="mb-4">
                ...
                <select name="tipe_mesin"
                    ...
                    <option selected>HAITIAN</option>
            ...
            <div class="mb-4">
                ...
                <select name="nama_produk"
                    ...
                    <option selected>Tutup Botol</option>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="operator" value="Sukiyo"
                    class="w-full rounded-lg border border-gray-300 px-4 py-2 focus:ring-2 focus:ring-purple-500 focus:outline-none">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="date" name="tanggal_mulai" value="2026-01-10"
                        class="w-full rounded-lg border border-gray-300 px-4 py-2 focus:ring-2 focus:ring-purple-500 focus:outline-none">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_selesai" value="2026-01-15"
                        class="w-full rounded-lg border border-gray-300 px-4 py-2 focus:ring-2 focus:ring-purple-500 focus:outline-none">
                </div>
            </div>
